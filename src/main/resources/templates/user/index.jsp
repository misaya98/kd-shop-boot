...
<head>
    ...
    <link id="layuicss-skinlayercss" rel="stylesheet" href="<%=basePath%>js/css/modules/layer/default/layer.css"
          media="all">
    ...
    <div class="header-wrap">
        ...
        <div class="nav-right fr">
            <c:if test="${!empty cur_user}">
                <a href="/user/index" class="log-btn"><img src="<%=basePath%>images/web/user/${cur_user.imgUrl}"
                                                           class="user-header-image">${cur_user.username}</a>
